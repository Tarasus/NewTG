...
/proc/generate_code_phrase()//Proc is used for phrase and response in master_controller.dm
	...
	var/drinks[] = list("водка и тоник","джин","багама мама","манхеттен","черный русский","виски сода","лонг айленд","маргарита","Ирландское кофе"," мужественный дворф","Ирландский крем","наслождение доктора","Бипски Смеш","текила санрайз","храбрый бык","бластер","кровавая мэри","виски кола","белый русский","водка мартини","мартини","Куба Либре","Калуа","водка","вино","самогон")
