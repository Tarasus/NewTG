...
datum/objective_item/steal/magboots
	name = "передовые магнитные ботинки главного инженера"
	targetitem =  /obj/item/clothing/shoes/magboots/advance
	difficulty = 5
	excludefromjob = list("Chief Engineer")

datum/objective_item/steal/corgimeat
	name = "кусочек м€са корги"
...
datum/objective_item/steal/plasma
	name = "28 моль плазмы (полный бак)"
...
datum/objective_item/steal/slime
	name = "неиспользованный образец экстракта слизн€"
...
datum/objective_item/special/aegun
	name = "усовершенствованный лазер"
