var/list/possible_changeling_IDs = list("Альфа","Бета","Гамма","Дельта","Эпсилон","Зета","Эта","Зета","Йота","Каппа","Лямбда","Му","Ну","Кси","Омикрон","Пи","Рху","Сигма","Тау","Апсилон","Фи","Чи","Пси","Омега")
