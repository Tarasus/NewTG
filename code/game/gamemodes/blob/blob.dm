...
/datum/game_mode/blob/announce()
	world << "<B>“екущий режим - <font color='green'>Ѕлоб</font>!</B>"
	world << "<B>ќпасный организм пожирает станцию!</B>"
	world << "¬ы должны уничтожить его свед&#255; ущерб станции к минимуму."
