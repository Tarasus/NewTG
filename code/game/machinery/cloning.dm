...
/obj/machinery/clonepod/proc/growclone(var/ckey, var/clonename, var/ui, var/se, var/mindref, var/datum/species/mrace, var/mcolor, var/factions. , var/horns_style)
	if(panel_open)
		return 0
	if(mess || attempting)
		return 0
