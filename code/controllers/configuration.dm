...
/datum/configuration
	...
	var/alert_desc_green = "¬се угрозы миновали. ќхрана не должна носить оружие на виду, законы вновь работают в полную силу."
	var/alert_desc_blue_upto = "—танци&#255; получила достоверную информацию о возможности вражеской де&#255;тельности на станции. ќхрана может носить оружие на виду, разрешаютс&#255; случайные обыски."
	var/alert_desc_blue_downto = "Ќепосредственна&#255; угроза миновала. ќхрана может по-прежнему носить оружие на виду. —лучайные обычки все еще разрешены."
	var/alert_desc_red_upto = "—уществует серьезна&#255; угроза станции. ќхрана может посто&#255;нно ходить с оружием. —лучайные обыски разрешены и рекомендуютс&#255;."
	var/alert_desc_red_downto = "ћеханизм самоуничтожени&#255; деактивирован, но угроза станции еще присутствует. ќхрана может посто&#255;нно ходить с оружием. —лучайные обыски разрешены и рекомендуютс&#255;."
	var/alert_desc_delta = "ћеханизм самоуничтожени&#255; активирован. Ёкипаж об&#255;зан исполн&#255;ть все инструкции данные их главами. Ћюбое нарушение может каратьс&#255; смертью. Ёто не учебна&#255; тревога."

	var/health_threshold_crit = -10	//пусть будет больше порог дамага дл€ крита.
