...
Режим с горячими клавишами: (должны быть включены)
...
\tf = сменить-намерения-влево
\tg = сменить-намерения-вправо
\t1 = намерения-помочь
\t2 = намерения-разоружить
\t3 = намерения-схватить
\t4 = намерения-вредить
</font>"}

	var/other = {"<font color='purple'>
Любой режим: (Горячие клавиши не должны быть включены)
\tCtrl+a = влево
\tCtrl+s = вниз
\tCtrl+d = вправо
\tCtrl+w = вверх
...
\tCtrl+f = сменить-намерения-влево
\tCtrl+g = сменить-намерения-вправо
\tCtrl+1 = намерения-помочь
\tCtrl+2 = намерения-разоружить
\tCtrl+3 = намерения-схватить
\tCtrl+4 = намерения-вредить
\tDEL = тащить
\tINS = сменить-намерения-вправо
\tHOME = положить
\tPGUP = сменить руки
...
\tCtrl+4 = включить намарения
\tDEL = nfobnm
\tINS = сменить-намерения
